...
namespace Ambev.DeveloperEvaluation.WebApi.Features.Products
{
    ...
    public class ProductController : ControllerBase
    {
        ...
        [ProducesResponseType(typeof(ApiResponse), StatusCodes.Status400BadRequest)]
        [ProducesResponseType(typeof(ApiResponse), StatusCodes.Status404NotFound)]
        public async Task<IActionResult> GetAllProducts([FromRoute] int pageNumber, int pageSize, CancellationToken cancellationToken)
        {
            var request = new GetAllProductRequest { PageNumber = pageNumber, PageSize = pageSize };
            ...
            return Ok(new ApiResponseWithData<GetAllProductPaginedResponse>
            {
                Success = true,
                Message = "Product retrieved successfully",
                Data = _mapper.Map<GetAllProductPaginedResponse>(response)
            });
        }
